...
app.post('/',function(req,res){
  ...
  var link="https://slack.com/api/chat.postMessage?token=xoxp-2315277109-4999683096-16794897169-67424f16cc&channel="+channel+"&text="+text+"&username="+username+"&pretty=1";
  var ts ="";
